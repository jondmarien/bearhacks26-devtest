...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col relative overflow-hidden font-primary">
      ...
      {/* Atmospheric Breathing Backdrop */}
      <motion.div
      ...
      <StaggerContainer className="flex-1 flex flex-col items-center justify-center p-4 pt-20 relative">
        <div className="text-center max-w-4xl mx-auto space-y-8">
          <StaggerItem className="inline-block px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs font-black tracking-[0.2em] text-blue-400 uppercase mb-4">
            March 20-22, 2026
          </StaggerItem>

          <StaggerItem className="text-7xl md:text-9xl font-black mb-6 text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-purple-500 to-pink-500 leading-[0.9] tracking-tighter">
            <motion.span
              variants={FLOATING_VARIANTS}
              animate="animate"
              className="inline-block will-change-transform px-4 py-2"
          ...
          <StaggerItem className="text-xl md:text-3xl text-gray-400 max-w-2xl mx-auto leading-relaxed font-medium">
